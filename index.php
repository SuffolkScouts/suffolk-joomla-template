...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/apple-touch-icon.png') ?>">
    <link rel="icon" type="image/png" sizes="32x32"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/favicon-32x32.png') ?>">
    <link rel="icon" type="image/png" sizes="16x16"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/favicon-16x16.png') ?>">
    <link rel="manifest"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/site.webmanifest') ?>">
    <link rel="mask-icon"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/safari-pinned-tab.svg') ?>"
        color="#490499">
    <link rel="shortcut icon"
        href="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/favicon.ico') ?>">
    <meta name="msapplication-TileColor" content="#490499">
    <meta name="msapplication-config"
        content="<?php echo ($this->baseurl . '/templates/' . $this->template . '/images/favicon/browserconfig.xml') ?>">
        ...
        <nav id="main-menu" class="navbar navbar-expand-lg navbar-light bg-faded">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                if ($user->guest) { //Display Login Link
                    ?>
                    <a class="navbar-text text-decoration-none" href="/?oauthlink=login">Login <i class="fa fa-user-o"
                            style="font-size: 1.2em; padding-left: 0.2em;"></i></a>
                    ...
                    <ul class="navbar-nav">
                        <li class="dropdown nav-item parent">
                            <a id="user-options" class="dropdown-toggle nav-link font-weight-bolder" href="#" role="button">
                                <?php echo $user->name; ?>
                            </a>
                            <ul class="dropdown-menu" aria-labelledby="user-options">
                                <li class="">
                                    <a class="dropdown-item" href="https://myaccount.microsoft.com/?ref=MeControl">
                                        My Account
                                    </a>
                                </li>

                                <li class="">
                                    <a class="dropdown-item" href="https://suffolkscouts-my.sharepoint.com/person.aspx">My
                                        Microsoft 365 Profile</a>
                                </li>
        ...
        <div class="container">
            ...
            <div class="row font-weight-light mt-4" style="font-size: 0.8em;">
                ...
                <div class="col-sm-4 text-center ">
                    &copy; 2011 -
                    <?php echo date('Y'); ?> Suffolk County Scout Council. All Rights Reserved.
                </div>
                <div class="col-sm-4">
                    <p class="text-right">
